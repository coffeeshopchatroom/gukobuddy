...
const MALE_AVATARS = [
  ...
  { id: 'mii-m4'}, { id: 'mii-m5'}, { id: 'mii-m6'},
  { id: 'mii-m7'}, { id: 'mii-m8'}, { id: 'mii-m9'},
]

const FEMALE_AVATARS = [
  { id: 'mii-f1'}, { id: 'mii-f2'}, { id: 'mii-f3'},
  { id: 'mii-f4'}, { id: 'mii-f5'}, { id: 'mii-f6'},
  { id: 'mii-f7'}, { id: 'mii-f8'},
]
      ...
      >
        ...
        <div className="absolute inset-0 z-50 flex flex-col items-center pt-40 px-60">
          <div className="w-full flex flex-col gap-4 mb-10">
            ...
            {step === 'selection' && (
              <p className="text-white/40 text-4xl font-headline lowercase italic animate-in fade-in duration-1000 delay-500">
                (more avatars coming soon! remember, it doesnt have to look exactly like you! just pick the one you like!)
              </p>
            )}
          </div>
          ...
          {step === 'gender' ? (
            ...
            <div className="grid grid-cols-3 gap-16 mt-10 w-full max-w-7xl animate-in fade-in slide-in-from-bottom-20 duration-700">
              {avatars.map((avatar) => (
                <button
                  key={avatar.id}
